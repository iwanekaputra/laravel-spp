        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 my-auto">
                    <p class="label-top text-primary" data-aos="fade-up" data-aos-duration="900">SPS —
                    ...
                    <p data-aos="fade-up" data-aos-duration="1300">
                        SPS adalah sebuah website yang menyediakan sistem pembayaran SPP online untuk mempermudah
                ...
                <div class="col-md-5" data-aos="fade-up" data-aos-duration="1700">
                    <img style="width: 80%" src="{{url('main-assets/images/smk-plus-muhammadiyah.jpeg')}}" alt=""
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 mx-auto text-center">
                    <p data-aos="fade-up" data-aos-duration="1000" class="text-primary label-top">TENTANG SPS</p>
                    <h1 data-aos="fade-up" data-aos-duration="1200">APA ITU SPS?</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-7 my-auto">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1400">
                        Dengan adanya SPS, kemudahan pembayaran SPP dapat dilakukan oleh petugas juga siswa dan juga
        ...
        <div class="container">
                ...
                <div class="header-instruction text-center">
                    <div class="col-md-7 mx-auto">
                        ...
                        <p data-aos="fade-up" data-aos-duration="1400">
                            ...
                            ini --}}
                            Cara masuk dan penggunaan pada aplikasi SPS, akan kami jelaskan secara rinci dibawah
                            ini.
                        </p>
                    </div>
                </div>
            ...
            <div class="row flex-column-reverse flex-md-row">
                <div class="col-md-8 my-auto">
                    ...
                    <h1 data-aos="fade-up" data-aos-duration="1400" class="mt-2">Login ke aplikasi SPS Menggunakan
    ...
    <section class="bonus-section mt-100">
        <div class="container">
            ...
            0 100px 100px rgba(0, 0, 0, 0.05);">
                <h1 class="fw-bold">Lakukan lebih dengan SPS</h1>
                <p class="lead">Tunggu apa lagi? segera coba aplikasi SPS agar anda dapat melihat history pembayaran
